...
const LevelProgress: React.FC<LevelProgressProps> = ({
  ...
  useEffect(() => {
    ...
    if (savedGameState) {
      ...
      setCurrentLevel(parsedState.currentLevel || initialCurrentLevel);
      setMaxUnlockedLevel(
        parsedState.maxUnlockedLevel || initialMaxUnlockedLevel
      );
      setScore(parsedState.score || initialScore);
    }
  }, [initialCurrentLevel, initialMaxUnlockedLevel, initialScore]);

  const handleClick = () => {
    navigate(`/game`, { state: { level: currentLevel } });
  };
